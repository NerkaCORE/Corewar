...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/21 13:14:32 by ybitton           #+#    #+#             */
/*   Updated: 2017/12/21 15:22:10 by ybitton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						instruction_exec(t_data *data, t_listb *elem);
void						free_params(unsigned int *to_free,
		unsigned int *to_free_2);
void						move_pc_bad_registers(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_types);
void						exec_no_ocp(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_types);
void						instr_no_ocp(t_data *data, t_listb *elem,
		unsigned int *params);
unsigned int				get_dir_value(t_data *data, t_listb *elem,
		int *prm_pos);
unsigned int				get_ind_value(t_data *data, t_listb *elem,
		int prm_pos);
unsigned int				trans_four_bytes(char *transfer_bytes);
char						*get_dir_value_quatre(t_data *data, t_listb *elem,
		int prm_pos);
void						apply_live(t_data *data, t_listb *elem);
void						apply_ld(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_type);
void						apply_st(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_type);
void						apply_add(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_type);
void						apply_sub(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_type);
void						apply_and(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_type);
void						apply_or(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_type);
void						apply_xor(t_data *data, t_listb *elem,
		unsigned int *params, unsigned int *param_type);
void						apply_zjmp(t_data *data, t_listb *elem,
		unsigned int *params);
void						apply_ldi(t_data *data, t_listb *elem,
		unsigned int *param_type, unsigned int *params);
void						apply_sti(t_data *data, t_listb *elem,
		unsigned int *param_type, unsigned int *params);
void						apply_fork(t_data *data, t_listb *elem,
		unsigned int *params);
void						apply_lld(t_data *data, t_listb *elem,
		unsigned int *param_type, unsigned int *params);
void						apply_lldi(t_data *data, t_listb *elem,
		unsigned int *param_type, unsigned int *params);
void						apply_lfork(t_data *data, t_listb *elem,
		unsigned int *params);
void						apply_aff(t_data *data, t_listb *elem,
		unsigned int *param_type, unsigned int *params);
...
char						*get_two_bytes(t_data *data, t_listb *elem,
		int prm_pos);
unsigned int				*get_params(unsigned int *par_types, t_data *data,
		t_listb *elem);
unsigned int				*det_types(t_data *data, t_listb *elem,
...
int							find_pc_pos(t_listb *list, int *pc,
							int nb_champ, int value);
int							*set_array_pc(t_listb *list_pc);
int							aff_window(t_data *data);
void						display_pc(t_data *data, int i,
							int *x_y, int champ_id);
void						clear_pc(t_data *data);
void						display_clear_pc(t_data *data, int i,
							int *x_y, int champ_id);
void						display_classique(t_data *data, int i,
							int *x_y, int champ_id);
